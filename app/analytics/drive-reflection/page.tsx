...
function DriveReflectionAnalyticsContent() {
  ...
  const [configEntry, setConfigEntry] = useState<DriveReflectionEntry | null>(null);
  ...
  const sorted = useMemo(() => {
    const getValue = (entry: DriveReflectionEntry) => {
    ...
    >
      ...
      {configEntry && canManageConfig && (
        <AnalyticsConfigModal
          ...
          collectionName="driveScouting"
          entityType="driveScouting"
