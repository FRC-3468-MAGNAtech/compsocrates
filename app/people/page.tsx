  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <div className="mb-6 rounded-xl border border-amber-300/30 bg-white/60 p-4 shadow-sm backdrop-blur-xl">
          <label className="block text-sm font-medium text-gray-700 mb-2">Search scouts and roles</label>
          <input
            className="w-full rounded-lg border border-gray-200 bg-white/80 px-3 py-2 outline-none focus:border-rose-400"
            value={search}
