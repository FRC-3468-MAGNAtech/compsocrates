...
function CoachDashboardContent() {
  ...
  const { avgAccuracy, totalEntries, totalScouts } = useScoutAccuracy();
      ...
      <div className="flex-1 overflow-y-auto">
        {activePage === "dashboard" && (
          <div className="p-8">
            ...
            {/* UPCOMING EVENT CARDS - BOTH EVENTS */}
                ...
                <div>
                  ...
                  <div className="mt-4 flex gap-4">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{daysUntilEvent('arkansas')}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Scouts Ready</p>
                      <p className="text-2xl font-bold">{totalScouts}/8</p>
                    </div>
                  </div>
                </div>
                <button
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="mt-4 flex gap-4">
                    <div>
                      <p className="text-sm text-gray-600">Days Until Event</p>
                      <p className="text-2xl font-bold">{daysUntilEvent('bayou')}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Scouts Ready</p>
                      <p className="text-2xl font-bold">{totalScouts}/8</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Train and improve accuracy</p>
                </button>
