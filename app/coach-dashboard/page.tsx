...
import { calculateTeamStats, getUpcomingEvent, formatActivity, type TeamStats } from "@/app/utils/stats-calculator";
...
function CoachDashboardContent() {
  ...
  async function loadDashboardData() {
    ...
    setLoading(true);
    try {
      const [teamStats, event] = await Promise.all([
                      ...
                      <div>
                        ...
                        <div className="mt-4 flex gap-4">
                          <div>
                            ...
                            <p className="text-2xl font-bold">{upcomingEvent.daysUntil}</p>
                          </div>
                          <div>
                            <p className="text-sm text-gray-600">Scouts Ready</p>
                            <p className="text-2xl font-bold">{stats?.activeScouts || 0}/{stats?.activeScouts || 0}</p>
                          </div>
                        </div>
                      </div>
                      <button
